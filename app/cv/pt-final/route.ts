...
const boxes: PdfBox[] = [
  ...
  { x: 52, y: 62, width: 288, height: 134, fill: [0.98, 0.99, 1], stroke: border as any },
  { x: 348, y: 62, width: 212, height: 134, fill: [0.98, 0.99, 1], stroke: border as any },
...
const lines: PdfLine[] = [
  ...
  { text: "São Paulo, Brasil   |   WhatsApp   |   ricardomachado.zulk@gmail.com   |   ricardozulkiewicz.com   |   linkedin.com/in/rick-zulk", x: 62, y: 706, size: 6.7, color: slate as any },
  { text: "RZ", x: 528, y: 718, size: 17, font: "bold", color: [1, 1, 1] },

  { text: "5 deals/mês", x: 82, y: 650, size: 11, font: "bold", color: navy as any },
  { text: "média aproximada na Talentu", x: 74, y: 639, size: 5.6, color: muted as any },
  ...
  { text: "~R$320k/mês", x: 462, y: 650, size: 11, font: "bold", color: navy as any },
  { text: "média aproximada de TCV", x: 465, y: 639, size: 5.6, color: muted as any },

  { text: "RESUMO EXECUTIVO", x: 58, y: 604, size: 10, font: "bold", color: navy as any },
  { text: "Account Executive com experiência em vendas consultivas B2B, outbound, CRM e estruturação comercial para tecnologia, startups e IT Outsourcing.", x: 58, y: 591, size: 7.1, color: slate as any },
  { text: "Atuação full-cycle em prospecção, discovery, qualificação, proposta, negociação e fechamento, com tickets de R$35k a R$120k.", x: 58, y: 581, size: 7.1, color: slate as any },
  { text: "Perfil combina execução comercial, leitura de ICP, relacionamento com decisores e construção de processos para previsibilidade.", x: 58, y: 571, size: 7.1, color: slate as any },

  { text: "EXPERIÊNCIA PROFISSIONAL", x: 58, y: 550, size: 10, font: "bold", color: navy as any },
  ...
  { text: "- Construção da abordagem comercial: ICP, segmentos prioritários, cadências, critérios de qualificação e materiais de apoio.", x: 66, y: 452, size: 6.9, color: slate as any },
  { text: "- Governança comercial em Pipedrive, padronizando etapas de pipeline, histórico, atividades, follow-ups e oportunidades.", x: 66, y: 442, size: 6.9, color: slate as any },
  { text: "- Criação de materiais e guias de CRM para apoiar adoção, previsibilidade comercial e alinhamento do time.", x: 66, y: 432, size: 6.9, color: slate as any },
  ...
  { text: "- Condução end-to-end de vendas consultivas B2B para startups, scale-ups e empresas em transformação digital.", x: 66, y: 370, size: 6.9, color: slate as any },
  { text: "- Atuação com C-level, RH e founders em reuniões estratégicas, diagnóstico, proposta, negociação e fechamento.", x: 66, y: 360, size: 6.9, color: slate as any },
  { text: "- Pipeline com cerca de 80% outbound, ciclo médio de 30-45 dias, tickets R$35k a R$120k e média de 5 deals/mês.", x: 66, y: 350, size: 6.9, color: slate as any },
  { text: "- Geração média aproximada de R$320k/mês em TCV, com variação entre R$180k e R$500k.", x: 66, y: 340, size: 6.9, color: slate as any },
  ...
  { text: "- Prospecção, qualificação, mapeamento de mercado e geração de conversas qualificadas para o time comercial.", x: 66, y: 258, size: 6.9, color: slate as any },
  { text: "- Apoio na definição de ICP, pesquisa de mercado, cadências outbound e passagem de oportunidades qualificadas.", x: 66, y: 248, size: 6.9, color: slate as any },
  ...
  { text: "- Estruturação de pipeline e governança de Pipedrive para operação comercial B2B,", x: 62, y: 164, size: 6.9, color: slate as any },
  { text: "  com critérios de avanço e acompanhamento de oportunidades.", x: 62, y: 154, size: 6.9, color: slate as any },
  { text: "- Criação de materiais de Sales Enablement: playbooks, one-pagers, roteiros", x: 62, y: 140, size: 6.9, color: slate as any },
  { text: "  comerciais e guias de CRM para padronizar abordagem e follow-up.", x: 62, y: 130, size: 6.9, color: slate as any },

  { text: "COMPETÊNCIAS", x: 356, y: 180, size: 10, font: "bold", color: navy as any },
  { text: "Vendas consultivas B2B | Outbound | Discovery", x: 356, y: 164, size: 6.9, color: slate as any },
  { text: "Qualificação | Negociação | CRM | Pipeline", x: 356, y: 154, size: 6.9, color: slate as any },
  ...
  { text: "Português: Nativo | Inglês: Profissional | Espanhol: Básico", x: 356, y: 69, size: 6.9, color: slate as any },

  { text: "ricardozulkiewicz.com | CV em português - versão premium para site", x: 210, y: 48, size: 5.8, color: muted as any },
];
